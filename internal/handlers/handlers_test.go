...
var theTests = []struct {
	...
	{"GET /generals-quarters", "/generals-quarters", "GET", http.StatusOK},
	{"GET /majors-suite", "/majors-suite", "GET", http.StatusOK},
...
func TestRepository_Reservation(t *testing.T) {
	...
	if rr.Code != http.StatusOK {
		t.Errorf("Reservation handler failed: expected code %d, got %d", http.StatusOK, rr.Code)
	}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("Reservation handler faild: expected %d but got %d", http.StatusTemporaryRedirect, rr.Code)
	}
