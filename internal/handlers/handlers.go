...
func (m *Repository) Reservation(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		m.App.Session.Put(r.Context(), "error", "failed to get reservation info from user session")
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "Failed to find room")
		http.Redirect(w, r, "/", http.StatusTemporaryRedirect)
		return
	}
...
// PostReservation handles the the posting of a reservation form
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	if len(rooms) == 0 {
		m.App.Session.Put(r.Context(), "error", "There are no available rooms for the selected period")
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		...
		// err := errors.New("cannot get item from session")
		// helpers.ServerError(w, err)
...
func (m *Repository) BookRoom(w http.ResponseWriter, r *http.Request) {
	...
	startDate := helpers.StrToDate(r.URL.Query().Get("s"), w)
	endDate := helpers.StrToDate(r.URL.Query().Get("e"), w)
